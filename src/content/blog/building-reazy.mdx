...
In this post, I’ll walk you through the project and provide the development story. I will also reveal some of the tradeoffs I made along the way.
...
This seemingly simple app was much more complicated to build than I initially thought, but it took me from low web developer capability to **a seasoned, grizzled full-stack developer**. What made it a journey was the tradeoff decisions, difficult bugs along the way, and the constant learning with spanning different clients and tools.
